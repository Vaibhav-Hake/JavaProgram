...
public class MainActivity extends AppCompatActivity {
    ...
    public class AndroidBridge {
        ...
        //mock test
        @JavascriptInterface
        public void analyzeResume(String base64Pdf, String jd) {

            runOnUiThread(() -> {
                webView.evaluateJavascript(
                        "showResumeResult('Analyzing Resume...')",
                        null
                );
            });
            ...
            new Thread(() -> {
                ...
                try {
                    ...
                    String pureBase64 = base64Pdf;

                    if(base64Pdf.contains(",")){
                        pureBase64 = base64Pdf.split(",")[1];
                    }
                    ...
                    // LIMIT LARGE PDF
                    if(pdfBytes.length > 2000000){

                        runOnUiThread(() -> {
                            webView.evaluateJavascript(
                                    "showResumeResult('PDF too large. Use smaller resume.')",
                                    null
                            );
                        });
                    ...
                    if(resumeText == null || resumeText.trim().isEmpty()){
                        ...
                        runOnUiThread(() -> {
                            webView.evaluateJavascript(
                                    "showResumeResult('Unable to extract text from PDF')",
                                    null
                            );
                        });
